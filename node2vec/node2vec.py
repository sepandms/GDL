...
arxiv_params     = {'embedding_dim':128 , 'batch_size':256, 'walk_length':15 , 'context_size':15 ,'walks_per_node':15, 'lr':0.01,'num_negative_samples':1,'p':1,'q':1 ,'epochs':40,'log_steps':100}
reddit_params    = {'embedding_dim':128 , 'batch_size':256, 'walk_length':15 , 'context_size':15 ,'walks_per_node':15, 'lr':0.01,'num_negative_samples':1,'p':1,'q':1 ,'epochs':40,'log_steps':100}
...
def main():
    ...
    plot_name = f'Node2Vec_{dataset_name}_Valid.png'
    if save_plots:
    ...
    plot_name = f'Node2Vec_{dataset_name}_Train.png'
    if save_plots:
        plt.savefig('./plots/'+plot_name)
    # plt.show()
