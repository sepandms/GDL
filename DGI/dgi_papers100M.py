...
dataset = PygNodePropPredDataset(name="ogbn-papers100M", root="/home/criscola/IdeaProjects/gdl/s3gc-code/DGI/dataset")
# dataset = PygNodePropPredDataset(name="cora", root="/home/criscola/IdeaProjects/gdl/s3gc-code/DGI/data")
...
#
# dataset = Planetoid(root='/home/criscola/IdeaProjects/gdl/s3gc-code/DGI/dataset', name='cora')
# data = dataset[0].to(device)
